...
const Text: React.FC = () => {
    ...
    return (
        <div>
            ...
            <Card title={'iframe方式'} style={{ width: '50%' }}>
                <iframe src="https://pdf.dfcfw.com/pdf/H2_AN202408061639155597_1.pdf?1722936327000.pdf#page=2"
                    title="PDF Viewer"
                    width="100%"
                    height="500px">
                </iframe>
            ...
            <Card title={'embed方式'} style={{ width: '50%' }}>
                <embed src="https://www.lilnong.top/static/pdf/B-4-RxJS%E5%9C%A8React%E4%B8%AD%E7%9A%84%E5%BA%94%E7%94%A8-%E9%BE%99%E9%80%B8%E6%A5%A0_.pdf#page=12"
                    title="PDF Viewer"
                    width="100%"
                    height="500px">
                </embed>
