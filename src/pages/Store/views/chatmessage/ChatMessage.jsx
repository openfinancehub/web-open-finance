...
import robotPNG from '@/pages/Store/assets/images/robot.png'
import userPNG from '@/pages/Store/assets/images/account.png'
import multiagent_supervisorPNG from '@/pages/Store/assets/images/multiagent_supervisor.png'
import multiagent_workerPNG from '@/pages/Store/assets/images/multiagent_worker.png'
import audioUploadSVG from '@/pages/Store/assets/images/wave-sound.jpg'
import nextAgentGIF from '@/pages/Store/assets/images/next-agent.gif'

// project import
import { CodeBlock } from '@/pages/Store/ui-component/markdown/CodeBlock'
import { MemoizedReactMarkdown } from '@/pages/Store/ui-component/markdown/MemoizedReactMarkdown'
import SourceDocDialog from '@/pages/Store/ui-component/dialog/SourceDocDialog'
import ChatFeedbackContentDialog from '@/pages/Store/ui-component/dialog/ChatFeedbackContentDialog'
import StarterPromptsCard from '@/pages/Store/ui-component/cards/StarterPromptsCard'
import { ImageButton, ImageSrc, ImageBackdrop, ImageMarked } from '@/pages/Store/ui-component/button/ImageButton'
import CopyToClipboardButton from '@/pages/Store/ui-component/button/CopyToClipboardButton'
import ThumbsUpButton from '@/pages/Store/ui-component/button/ThumbsUpButton'
import ThumbsDownButton from '@/pages/Store/ui-component/button/ThumbsDownButton'
import './ChatMessage.css'
import { cancelAudioRecording, startAudioRecording, stopAudioRecording } from './audio-recording'
import './audio-recording.css'

// api
import chatmessageApi from '@/pages/Store/api/chatmessage'
import chatflowsApi from '@/pages/Store/api/chatflows'
import predictionApi from '@/pages/Store/api/prediction'
import chatmessagefeedbackApi from '@/pages/Store/api/chatmessagefeedback'
import leadsApi from '@/pages/Store/api/lead'

// Hooks
import useApi from '@/pages/Store/hooks/useApi'

// Const
import { baseURL, maxScroll } from '@/pages/Store/store/constant'
import { enqueueSnackbar as enqueueSnackbarAction, closeSnackbar as closeSnackbarAction } from '@/pages/Store/store/actions'

// Utils
import { isValidURL, removeDuplicateURL, setLocalStorageChatflow, getLocalStorageChatflow } from '@/pages/Store/utils/genericHelper'
