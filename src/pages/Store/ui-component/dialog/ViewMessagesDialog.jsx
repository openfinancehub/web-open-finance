...
import msgEmptySVG from '@/pages/Store/assets/images/message_empty.svg'
...
import Feedback from '@/pages/Store/ui-component/extended/Feedback'
...
import feedbackApi from '@/pages/Store/api/feedback'
import useApi from '@/pages/Store/hooks/useApi'
import useConfirm from '@/pages/Store/hooks/useConfirm'

// Utils
import { getOS, isValidURL, removeDuplicateURL } from '@/pages/Store/utils/genericHelper'
...
import '@/pages/Store/views/chatmessage/ChatMessage.css'
